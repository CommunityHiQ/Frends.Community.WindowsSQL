...
namespace Frends.Community.WindowsSQL
{
    ...
    {
        /// <summary>
        /// Execute a sql query. Can only return one dataset per query. https://github.com/FrendsPlatform/Frends.Community.WindowsSQL
        /// </summary>
        ...
        /// <summary>
        /// Execute a stored procedure. Can only return one dataset per execution. https://github.com/FrendsPlatform/Frends.Community.WindowsSQL
        /// </summary>
        /// <param name="input">Input parameters</param>
        /// <param name="options">Optional parameters with default values</param>
        /// <returns>JToken</returns>
        ...
        /// <summary>
        /// Create a query for a batch operation like insert. The query is executed with Dapper ExecuteAsync. https://github.com/FrendsPlatform/Frends.Community.WindowsSQL
        /// </summary>
        /// <param name="input">Input parameters</param>
        /// <param name="options">Optional parameters with default values</param>
        ...
        /// <summary>
        /// Bulk insert json data to a SQL table. https://github.com/FrendsPlatform/Frends.Community.WindowsSQLvv
        /// </summary>
        /// <param name="input">Input parameters</param>
        /// <param name="options">Optional parameters with default values</param>
